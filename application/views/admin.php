...
<!--                                                    <input type="text" class="form-control" id="asunto" name="asunto" placeholder="Asunto">-->
                                                    <select class="form-control" id="asunto" name="asunto">
                                                        ...
                                                        <option value="REGISTRO CAMBIO DE NOMBRE Y RECTIFICACION">REGISTRO CAMBIO DE NOMBRE Y RECTIFICACION</option>
                                                        <option value="CERTIFICACIONES CATASTRALES">CERTIFICACIONES CATASTRALES</option>
                                                        <option value="TRANFERENCIAS">TRANFERENCIAS</option>
                                                        <option value="ARCHIVOS CATASTROS Y CODIFICACION">ARCHIVOS CATASTROS Y CODIFICACION</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
